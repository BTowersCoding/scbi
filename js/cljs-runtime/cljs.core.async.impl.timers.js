...
var i_31693 = (0);
while(true){
if((i_31693 < arr.length)){
(arr[i_31693] = null);

var G__31694 = (i_31693 + (1));
i_31693 = G__31694;
continue;
} else {
}
...
var i_31787 = (self__.level + (1));
while(true){
if((i_31787 <= (new_level + (1)))){
(update[i_31787] = self__.header);

var G__31788 = (i_31787 + (1));
i_31787 = G__31788;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_31789 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_31789[i]));
} else {
x__$2.forward.push((((i < links_31789.length))?(links_31789[i]):null));
}

if((i < links_31789.length)){
(links_31789[i] = x__$2);
} else {
links_31789.push(x__$2);
}
...
var i_31792 = (0);
while(true){
if((i_31792 <= self__.level)){
var links_31793 = (update[i_31792]).forward;
if((x__$1 === (((i_31792 < links_31793.length))?(links_31793[i_31792]):null))){
(links_31793[i_31792] = (x__$1.forward[i_31792]));

var G__31796 = (i_31792 + (1));
i_31792 = G__31796;
continue;
} else {
var G__31798 = (i_31792 + (1));
i_31792 = G__31798;
continue;
}
} else {
...
var G__31801 = nx;
var G__31802 = (level__$1 - (1));
x = G__31801;
level__$1 = G__31802;
continue;
} else {
var G__31803 = x;
var G__31804 = (level__$1 - (1));
x = G__31803;
level__$1 = G__31804;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__31806 = nx;
var G__31807 = (level__$1 - (1));
x = G__31806;
level__$1 = G__31807;
continue;
} else {
var G__31808 = x;
var G__31809 = (level__$1 - (1));
x = G__31808;
level__$1 = G__31809;
continue;
}
