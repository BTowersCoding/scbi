...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_31064 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_31064(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_31065 = (function (port,val,fn1_handler){
var x__4509__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_31065(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_31066 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_31066(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_31067 = (function (chan){
var x__4509__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_31067(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_31068 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_31068(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_31069 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_31069(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_31074 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_31074(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_31079 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_31079(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_31088 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_31088(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_31089 = (function (b,itm){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_31089(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_31090 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_31090(b);
}
});
