...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_36938 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_36938(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_36939 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_36939(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_36942 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_36942(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_37005 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_37005(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_37014 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_37014(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__36936,callback){
var map__36937 = p__36936;
var map__36937__$1 = cljs.core.__destructure_map(map__36937);
var input = map__36937__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36937__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36937__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
