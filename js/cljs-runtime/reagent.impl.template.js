...
var G__39749 = o;
goog.object.set(G__39749,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__39768__i < G__39768__a.length) {G__39768__a[G__39768__i] = arguments[G__39768__i + 0]; ++G__39768__i;}
  args = new cljs.core.IndexedSeq(G__39768__a,0,null);
} 
...
var G__39750 = o;
goog.object.set(G__39750,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__39770__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__39771__i < G__39771__a.length) {G__39771__a[G__39771__i] = arguments[G__39771__i + 0]; ++G__39771__i;}
  args = new cljs.core.IndexedSeq(G__39771__a,0,null);
} 
return G__39770__delegate.call(this,args);};
G__39770.cljs$lang$maxFixedArity = 0;
G__39770.cljs$lang$applyTo = (function (arglist__39772){
var args = cljs.core.seq(arglist__39772);
return G__39770__delegate(args);
});
...
var G__39751 = props;
var G__39751__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39751,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__39751);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39751__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__39752 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39752,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__39752;
}
})(),id_class);
...
var G__39753 = (cljs.core.count(argv) - first_child);
switch (G__39753) {
case (0):
...
var vec__39754 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39754,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39754,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39754,(2),null);
...
var temp__5757__auto___39778 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___39778 == null)){
} else {
var key_39779 = temp__5757__auto___39778;
(jsprops.key = key_39779);
}
...
var temp__5757__auto___39780 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___39780 == null)){
} else {
var key_39781 = temp__5757__auto___39780;
(jsprops.key = key_39781);
}
...
var temp__5757__auto___39783 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___39783 == null)){
} else {
var key_39784 = temp__5757__auto___39783;
(jsprops.key = key_39784);
}
...
var temp__5757__auto___39786 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___39786 == null)){
} else {
var key_39787 = temp__5757__auto___39786;
(jsprops.key = key_39787);
}
...
var temp__5757__auto___39788 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___39788 == null)){
} else {
var key_39789 = temp__5757__auto___39788;
(jsprops.key = key_39789);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39757_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__39757_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__39758 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39758,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39758,(1),null);
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template39764 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template39764 = (function (opts,id,fn_to_element,parse_fn,meta39765){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template39764.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39766,meta39765__$1){
var self__ = this;
var _39766__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template39764(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta39765__$1));
}));

(reagent.impl.template.t_reagent$impl$template39764.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39766){
var self__ = this;
var _39766__$1 = this;
return self__.meta39765;
}));

(reagent.impl.template.t_reagent$impl$template39764.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template39764.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template39764.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template39764.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template39764.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template39764.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta39765","meta39765",-119004026,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template39764.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template39764.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template39764");

(reagent.impl.template.t_reagent$impl$template39764.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template39764");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template39764.
 */
reagent.impl.template.__GT_t_reagent$impl$template39764 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template39764(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta39765){
return (new reagent.impl.template.t_reagent$impl$template39764(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta39765));
});

}

return (new reagent.impl.template.t_reagent$impl$template39764(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
